...
cv::Mat camshifttracker::mainImage;
...
void camshifttracker::setMainImage(const cv::Mat _mainImage)
{
    _mainImage.copyTo(mainImage);
}

cv::Mat camshifttracker::getMainImage()
{
    return mainImage;
}

void camshifttracker::setCurrentRect(const cv::Rect _currentRect)
{
    currentRect = _currentRect;
    selection = currentRect;
}

cv::Rect camshifttracker::getCurrentRect()
{
    return currentRect;
}

cv::RotatedRect camshifttracker::trackCurrentRect()
{
