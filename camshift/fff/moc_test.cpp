...
QT_MOC_LITERAL(1, 5, 8), // "gotFrame"
QT_MOC_LITERAL(2, 14, 0), // ""
QT_MOC_LITERAL(3, 15, 14), // "unsigned char*"
QT_MOC_LITERAL(4, 30, 8), // "oneFrame"
QT_MOC_LITERAL(5, 39, 4) // "data"

    },
    "Test\0gotFrame\0\0unsigned char*\0oneFrame\0"
    "data"
};
...
void Test::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->gotFrame((*reinterpret_cast< unsigned char*(*)>(_a[1]))); break;
        case 1: _t->oneFrame((*reinterpret_cast< unsigned char*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (Test::*_t)(unsigned char * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Test::gotFrame)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void Test::gotFrame(unsigned char * _t1)
{
